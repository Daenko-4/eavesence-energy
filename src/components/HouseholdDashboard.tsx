          ...
          <section className="mt-8 grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">
            <div id="monthly-check-in" className={`${homeSurfaceClass} scroll-mt-24 p-5`}>
              ...
              <div className="mt-5 grid grid-cols-2 rounded-full border border-[#dfe5dd] bg-[#eef1ed] p-1">
                <button type="button" aria-pressed={checkInMode === "consumption"} onClick={() => { setCheckInMode("consumption"); setCheckInFeedback(null); }} className={`home-primary-action rounded-full border-0 px-3 py-1 transition ${checkInMode === "consumption" ? "bg-[#ddf8e9] text-[var(--brand-green)]" : "bg-transparent text-[#65716d] hover:bg-white/70 hover:text-[#17211f]"}`}>{text.consumptionEntry}</button>
                <button type="button" aria-pressed={checkInMode === "bill"} onClick={() => { setCheckInMode("bill"); setCheckInFeedback(null); }} className={`home-primary-action rounded-full border-0 px-3 py-1 transition ${checkInMode === "bill" ? "bg-[#ddf8e9] text-[var(--brand-green)]" : "bg-transparent text-[#65716d] hover:bg-white/70 hover:text-[#17211f]"}`}>{text.billEntry}</button>
              </div>
